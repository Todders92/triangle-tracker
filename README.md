...
#### _An Application for Determining If A Shape Is A Triangle January 2020_

#### By _**Todd Walraven**_

## Description

_This application has the user put in the length of 3 sides and determines if the sides would make a triangle and if so, which kind of triangle it would be._
